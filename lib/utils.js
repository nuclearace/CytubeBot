const utils =
    {
      ...
      'genericUIDLoop': (bot, data) => {
        ...
        if (!bot[kind]) {
          return bot.logger.errlog.log(
              '!~~~! genericUIDLoop No such method: ' + kind);
        }
      ...
      'parseForecastData': (bot, forecastData) => {
        ...
        var forecast = {
          ...
          'todayNight':
              parsedJSON['forecast']['txt_forecast']['forecastday'][1],
          'tomorrowDay':
              parsedJSON['forecast']['txt_forecast']['forecastday'][2],
          'tomorrowNight':
              parsedJSON['forecast']['txt_forecast']['forecastday'][3],
        };
