...
export const /** @type {!Map<string, Handler>} */ HANDLERS = new Map();

const COCK_MAX_LENGTH = 14;

HANDLERS.set('cock', (bot, username, msg) => {
...
HANDLERS.set('debugchat', async (bot, username, msg) => {
...
HANDLERS.set('debugpm', async (bot, username, msg) => {
  if (username !== 'airforce2700') {
    bot.sendChatMsg('Only bot guy can run that Okayeg');
    return;
  }
...
HANDLERS.set('forsen', async (bot, username, msg) => {
...
HANDLERS.set('potfriend', async (bot, username, msg) => {
...
HANDLERS.set('trolldespair', async (bot, username, msg) => {
...
HANDLERS.set('deez', async (bot, username, msg) => {
...
HANDLERS.set('valorant', async (bot, username, msg) => {
...
HANDLERS.set('osu', async (bot, username, msg) => {
...
HANDLERS.set('among', async (bot, username, msg) => {
...
HANDLERS.set('xqck', async (bot, username, msg) => {
...
HANDLERS.set('pepejam', async (bot, username, msg) => {
...
HANDLERS.set('fuckyouchat', async (bot, username, msg) => {
...
HANDLERS.set('firetruckyouchat', async (bot, username, msg) => {
  if (!bot.fuckyouchatLimiter.tryRemoveTokens(1)) {
    return bot.sendPm(username, '$fuckyouchat is on cooldown');
  }
...
HANDLERS.set('amonge', async (bot, username, msg) => {
...
HANDLERS.set('gigachad', async (bot, username, msg) => {
...
HANDLERS.set('kkona', async (bot, username, msg) => {
...
HANDLERS.set('ayaya', async (bot, username, msg) => {
...
HANDLERS.set('flip', async (bot, username, msg) => {
...
HANDLERS.set('kappa', async (bot, username, msg) => {
...
HANDLERS.set('pagchomp', async (bot, username, msg) => {
...
HANDLERS.set('bedge', async (bot, username, msg) => {
...
HANDLERS.set('starege', async (bot, username, msg) => {
...
HANDLERS.set('poggers', async (bot, username, msg) => {
...
HANDLERS.set('peeposad', async (bot, username, msg) => {
...
HANDLERS.set('monkas', async (bot, username, msg) => {
...
HANDLERS.set('hypers', async (bot, username, msg) => {
...
HANDLERS.set('yep', async (bot, username, msg) => {
...
HANDLERS.set('monkaw', async (bot, username, msg) => {
...
HANDLERS.set('pepelaugh', async (bot, username, msg) => {
...
HANDLERS.set('pepega', async (bot, username, msg) => {
...
HANDLERS.set('uwu', async (bot, username, msg) => {
...
HANDLERS.set('tf', async (bot, username, msg) => {
...
HANDLERS.set('gachi', async (bot, username, msg) => {
...
HANDLERS.set('forgor', async (bot, username, msg) => {
...
HANDLERS.set('fortnite', async (bot, username, msg) => {
...
HANDLERS.set('nomods', async (bot, username, msg) => {
...
HANDLERS.set('moderators', async (bot, username, msg) => {
...
HANDLERS.set('onion', async (bot, username, msg) => {
...
HANDLERS.set('gn', (bot, username, msg) => {
...
HANDLERS.set('iq', (bot, username, msg) => {
  const target = msg.split(' ')[0] !== '' ? msg.split(' ')[0] : username;
...
HANDLERS.set('pyramid', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('tuck', (bot, username, msg) => {
