...
var chatHandlers = {
	...
	"forecast": function(bot, username, data) {
		...
		bot.weatherLimiter.removeTokens(1, function(err, remainingRequests) {
			api.APICall(data, "forecast", bot.weatherunderground, postAPI)
		})
	},

	"help": function(bot, username, data) {
	...
	"squee": function(bot, username, data) {
		...
		bot.squeeLimiter.removeTokens(1, function(err, tokensRemaining) {
