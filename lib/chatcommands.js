...
import {filterMsg, genericUIDLoop, getCurrentUnixTimestamp, getUser, kill, parseBumpData, parseDeleteData, parseForecastData, parseMediaLink, parseUserlimit, sendPmsWithRateLimit, sleep} from './utils.js';
...
CHAT_HANDLERS.set('userstats', async (bot, username, msg) => {
  ...
  bot.sendChatMsg(
      `${target} has sent ${chatCount} messages, random quote: ${quote}`);
});
