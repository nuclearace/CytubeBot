...
CHAT_HANDLERS.set('chatleaderboard', async (bot, username, msg) => {
  const pageSize = 5;
...
CHAT_HANDLERS.set('chatrank', async (bot, username, msg) => {
...
CHAT_HANDLERS.set('chats', async (bot, username, msg) => {
  const target = msg.split(' ')[0] !== '' ? msg.split(' ')[0] : username;
...
CHAT_HANDLERS.set('here', async (bot, username, msg) => {
...
CHAT_HANDLERS.set('everyone', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
CHAT_HANDLERS.set('mods', async (bot, username, msg) => {
...
CHAT_HANDLERS.set('admins', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
CHAT_HANDLERS.set('staff', async (bot, username, msg) => {
...
CHAT_HANDLERS.set('userlogs', async (bot, username, msg) => {
