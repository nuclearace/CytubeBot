...
CHAT_HANDLERS.set('smp', async (bot, username, msg) => {
  ...
  if (sl1 === sl3 && sl1 !== sl2) {
    if (sl1 === 'xqcL' || sl1 === 'PagMan' || sl1 === 'TriHard' || sl1 === 'klaiusGuraRickRoll' ||
        sl1 === 'FEELSWAYTOOGOOD' || sl3 === 'xqcL' || sl3 === 'PagMan' ||
        sl3 === 'TriHard' || sl3 === 'klaiusGuraRickRoll' || sl3 === 'FEELSWAYTOOGOOD') {
  ...
  if (sl2 === sl3 && sl1 !== sl2) {
    if (sl2 === 'xqcL' || sl2 === 'PagMan' || sl2 === 'TriHard' || sl2 === 'klaiusGuraRickRoll' ||
        sl2 === 'FEELSWAYTOOGOOD' || sl3 === 'xqcL' || sl3 === 'PagMan' ||
        sl3 === 'TriHard' || sl3 === 'klaiusGuraRickRoll' || sl3 === 'FEELSWAYTOOGOOD') {
      win = (gambledPoints * 20);
    } else if (
  ...
  if (sl1 === sl2 && sl1 !== sl3) {
    if (sl1 === 'xqcL' || sl1 === 'PagMan' || sl1 === 'TriHard' || sl1 === 'klaiusGuraRickRoll' ||
        sl1 === 'FEELSWAYTOOGOOD' || sl2 === 'xqcL' || sl2 === 'PagMan' ||
