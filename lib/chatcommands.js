...
import {HANDLERS as CUSTOM_HANDLERS} from './custom.js';
...
HANDLERS.set('acceptduel', async (bot, username, msg) => {
...
HANDLERS.set('add', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('addpoints', async (bot, username, msg) => {
...
HANDLERS.set('addrandom', async (bot, username, msg) => {
...
HANDLERS.set('allow', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('anagram', async (bot, username, msg) => {
...
HANDLERS.set('ask', (bot, username, msg) => {
  const answers = ['Yes', 'No'];
  const answer = answers[randomInt(answers.length)];
  bot.sendChatMsg(`"${msg}"? ${answer}.`);
});

HANDLERS.set('autodelete', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('ban', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('blacklist', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('blacklistedusers', (bot, username, msg) => {
  bot.listBlacklistedUsers();
});

HANDLERS.set('blacklistuser', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('blockedusers', (bot, username, msg) => {
  bot.listBlockedUsers();
});

HANDLERS.set('blockuser', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('bump', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('chatleaderboard', async (bot, username, msg) => {
  const pageSize = 5;
...
HANDLERS.set('chatrank', async (bot, username, msg) => {
...
HANDLERS.set('chats', async (bot, username, msg) => {
  const target = msg.split(' ')[0] !== '' ? msg.split(' ')[0] : username;
...
HANDLERS.set('checkplaylist', (bot) => {
  bot.checkPlaylist();
});

HANDLERS.set('cleandatabasevideos', async (bot, username, msg) => {
...
HANDLERS.set('choose', (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('clearchat', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'M'))) {
...
HANDLERS.set('cookie', async (bot, username, msg) => {
  {
...
HANDLERS.set('cookies', async (bot, username, msg) => {
  const target = msg.split(' ')[0] !== '' ? msg.split(' ')[0] : username;
...
HANDLERS.set('cleverbot', async (bot, username, msg) => {
...
HANDLERS.set('delete', async (bot, username, msg) => {
...
HANDLERS.set('deletevideos', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.FOUNDER, null))) {
...
HANDLERS.set('disallow', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, 'M'))) {
...
HANDLERS.set('duel', async (bot, username, msg) => {
...
HANDLERS.set('duplicates', async (bot, username, msg) => {
...
HANDLERS.set('endpoll', async (bot, username, msg) => {
...
HANDLERS.set('ecount', emoteCountHandler);
HANDLERS.set('emotecount', emoteCountHandler);

HANDLERS.set('emotes', (bot, username, msg) => {
...
HANDLERS.set('givepoints', async (bot, username, msg) => {
  const targetUser = msg.split(' ')[0];
  if (!targetUser) {
    return;
  }
...
HANDLERS.set('islive', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!bot.twitch) {
...
HANDLERS.set('ipban', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, 'N'))) {
...
HANDLERS.set('join', async (bot, username, msg) => {
...
HANDLERS.set('kick', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('lasttweet', async (bot, username, msg) => {
  if (!bot.twitter) {
...
HANDLERS.set('leaderboard', async (bot, username, msg) => {
  const pageSize = 5;
  const pageMsg = msg.split(' ')[0];
  const pageMsgParsed = pageMsg !== '' ? parseInt(pageMsg, 10) : 1;
  const pageNumber = !isNaN(pageMsgParsed) ? pageMsgParsed : 1;
...
HANDLERS.set('listpermissions', (bot, username, msg) => {
  const name = msg || username;
  sendHybridModPermissions(bot, name.toLowerCase());
});

HANDLERS.set('logs', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('management', async (bot, username, msg) => {
...
HANDLERS.set('module', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('modulesoff', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('moduleson', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('mute', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'M'))) {
...
HANDLERS.set('nonotifylive', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('notifylive', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('notifylivelist', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
    bot.sendChatMsg(`${username} does not have permission to notifylive. FeelsWeirdMan`);
    return;
  }
...
HANDLERS.set('p', pointsHandler);
HANDLERS.set('points', pointsHandler);
HANDLERS.set('userpoints', pointsHandler);

HANDLERS.set('raffle', async (bot, username, msg) => {
...
HANDLERS.set('removepoints', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('permissions', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.ADMIN, null))) {
...
HANDLERS.set('ping', async (bot, username, msg) => {
  bot.sendChatMsg(`${username}: MrDestructoid Donk`);
});

// Unlisted command.
HANDLERS.set('playlistdebug', (bot, username, msg) => {
  if (msg) {
...
HANDLERS.set('poll', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, 'P'))) {
...
HANDLERS.set('poof', async (bot, username, msg) => {
...
HANDLERS.set('processinfo', (bot) => {
  const info = process.memoryUsage();
  bot.sendChatMsg(`Heap total: ${info.heapTotal} Heap used: ${info.heapUsed}`);
});

HANDLERS.set('purge', (bot, username, msg) => {
  if (!msg) {
    msg = username;
  }

  msg = `${msg.trim()} all`;
  HANDLERS.get('delete')(bot, username, msg);
});

HANDLERS.set('quote', async (bot, username, msg) => {
...
HANDLERS.set('randomchat', async (bot, username, msg) => {
...
HANDLERS.set('randomemote', (bot, username, msg) => {
...
HANDLERS.set('rank', async (bot, username, msg) => {
  const target = msg.split(' ')[0] !== '' ? msg.split(' ')[0] : username;
...
HANDLERS.set('resetrestartcount', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.ADMIN, 'K'))) {
    bot.sendChatMsg(
...
HANDLERS.set('restart', async (bot, username, msg) => {
...
HANDLERS.set('rngban', async (bot, username, msg) => {
  if ((await bot.db.getUserRank(username)) >= Rank.MOD) {
...
HANDLERS.set('rngkick', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
HANDLERS.set('rngping', async (bot, username, msg) => {
...
HANDLERS.set('here', async (bot, username, msg) => {
...
HANDLERS.set('everyone', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
HANDLERS.set('mods', async (bot, username, msg) => {
...
HANDLERS.set('admins', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
HANDLERS.set('staff', async (bot, username, msg) => {
...
HANDLERS.set('rngtempban', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
HANDLERS.set('rngtimeout', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('roulette', async (bot, username, msg) => {
...
HANDLERS.set('smp', async (bot, username, msg) => {
...
HANDLERS.set('settime', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('shuffle', async (bot, username, msg) => {
...
HANDLERS.set('skip', async (bot, username, msg) => {
...
HANDLERS.set('spam', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('stats', async (bot, username, msg) => {
...
HANDLERS.set('status', (bot, username, msg) => {
...
HANDLERS.set('tempban', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
HANDLERS.set('tempbans', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'I'))) {
...
HANDLERS.set('timeout', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('timeouts', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, null))) {
...
HANDLERS.set('title', async (bot, username, msg) => {
  const channelName = msg.split(' ')[0];
  if (!channelName) {
...
HANDLERS.set('translate', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('unban', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
  if (!(await bot.checkPermission(username, Rank.MOD, 'N'))) {
...
HANDLERS.set('unmute', async (bot, username, msg) => {
  if (!(await bot.checkPermission(username, Rank.MOD, 'M'))) {
...
HANDLERS.set('update', async (bot, username, msg) => {
...
HANDLERS.set('userlogs', async (bot, username, msg) => {
...
HANDLERS.set('userlimit', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('userstats', async (bot, username, msg) => {
  const target = msg.split(' ')[0] !== '' ? msg.split(' ')[0] : username;
...
HANDLERS.set('weather', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
HANDLERS.set('wolfram', async (bot, username, msg) => {
...
HANDLERS.set('#showemote', async (bot, username, msg) => {
  if (!msg) {
    return;
  }
...
export function handle(bot, username, msg) {
  ...
  for (const handlerSet of ALL_HANDLERS) {
