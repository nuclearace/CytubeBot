...
CytubeBot.prototype.handleBanlist = function(data) {
	...
	//console.log(bot.waitingFunctions.length)
	for (var i = 0; i < this.waitingFunctions.length; i++) {
		if (this.waitingFunctions[i]["unban"]) {
			this.waitingFunctions[i]["fun"](function() {
