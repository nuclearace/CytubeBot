...
CytubeBot.prototype.addRandomVideos = num => {
  var bot = this;
...
// pos - position to add
CytubeBot.prototype.addVideo = (type, id, duration, temp, pos, parsedLink) => {
  var json = {};
  var bot = this;
  ...
  if (!parsedLink) {
    ...
    this.addVideoLimiter.removeTokens(1, () => bot.socket.emit('queue', json));
  } else {
    json = {
      'id': parsedLink['id'],
...
CytubeBot.prototype.blacklistUser = (username, flag) => {
  var bot = this;
...
CytubeBot.prototype.blacklistVideo = (uid, callback) => {
  var type = '';
  var id = '';
  var flags = 1;
  var title = '';
...
CytubeBot.prototype.blockUser = (username, flag) => {
  var bot = this;
...
CytubeBot.prototype.blockVideo = () => {
...
// callback - The callback function
CytubeBot.prototype.checkPermission =
    (username, rank, permission, callback) => {
      var permData = {
        username: username,
        rank: rank,
...
CytubeBot.prototype.checkPlaylist = () => {
  var bot = this;
...
// callback - The callback function
CytubeBot.prototype.checkUserBlacklist = (username, callback) => {
...
// callback - The callback function
CytubeBot.prototype.checkUserBlock = (username, callback) => {
  if (!username) {
...
CytubeBot.prototype.cleanDatabaseVideos = () => {
  var self = this;
            ...
            (shouldDelete, why) => {
              ...
              if (count === num) {
                self.sendChatMsg('Found ' + numFlagged + ' invalid videos');
                                   ...
                                   self.videoLookupLimiter.removeTokens(
                                       1, () => {
                                         count++;
                                         validator.validate(
                                             self, video.id, video.type,
                                             video.title, postValidate);
                                       });
      });
    });
  });
...
CytubeBot.prototype.countVideosAddedByUser = username => {
  if (!username) {
    for (var i = 0; i < this.userlist.length; i++) {
      var uids =
          utils.handle(this, 'findVideosAddedByUser', this.userlist[i]['name']);
...
// poll - Poll object
CytubeBot.prototype.createPoll = poll => {
...
CytubeBot.prototype.deleteVideo = uid => {
  if (typeof uid !== 'undefined') {
...
CytubeBot.prototype.deleteVideosFromDatabase = like => {
  var bot = this;
...
CytubeBot.prototype.disallowUser = (user, disallow) => {
...
CytubeBot.prototype.getQuote = nick => {
  var bot = this;
...
CytubeBot.prototype.getSocketURL = server => {
  var bot = this;
...
// the database
CytubeBot.prototype.getGeneralStats = () => {
  var bot = this;
...
// data - addUser data
CytubeBot.prototype.handleAddUser = data => {
...
// it executes it
// data - The banlist
CytubeBot.prototype.handleBanlist = data => {
  var bot = this;
  this.banlist = data;
...
CytubeBot.prototype.handleChangeMedia = data => {
...
// commands.
CytubeBot.prototype.handleChatMsg = (data, pm) => {
  var bot = this;
  ...
  var handleCommand = msg.indexOf('$') === 0 &&
      username.toLowerCase() !== this.username.toLowerCase() && this.loggedIn &&
      allowed();
...
// data - delete data
CytubeBot.prototype.handleDeleteMedia = data => {
  var uid = data['uid'];
  var index = utils.handle(this, 'findIndexOfVideoFromUID', uid);
...
CytubeBot.prototype.handleEmoteUpdate = emote => {
  if (!this.enableWebServer) {
    return;
  }
...
CytubeBot.prototype.handleHybridModPermissionChange = (permission, name) => {
  var permData = {
    permission: permission,
    name: name,
  };
...
// data - The login data
CytubeBot.prototype.handleLogin = data => {
  var bot = this;
  if (!data['success']) {
...
CytubeBot.prototype.handleMediaUpdate = data => {
  console.log(
...
// data - moveMedia data
CytubeBot.prototype.handleMoveMedia = data => {
  var from = data['from'];
...
CytubeBot.prototype.handleNeedPassword = () => {
...
CytubeBot.prototype.handlePlaylist = playlist => {
  var bot = this;
  for (var i = 0; i < this.userlist.length; i++) {
...
CytubeBot.prototype.handleRemoveEmote = emote => {
  if (!this.enableWebServer) {
    return;
  }
...
CytubeBot.prototype.handleSetCurrent = uid => {
...
CytubeBot.prototype.handleSetLeader = name => {
...
// data - setTemp data
CytubeBot.prototype.handleSetTemp = data => {
  var temp = data['temp'];
  var uid = data['uid'];
...
CytubeBot.prototype.handleSetUserRank = data => {
  for (var i = 0; i < this.userlist.length; i++) {
...
// user - userLeave data
CytubeBot.prototype.handleUserLeave = user => {
...
CytubeBot.prototype.handleUserlist = userlistData => {
...
CytubeBot.prototype.listBlacklistedUsers = () => {
  var bot = this;
...
CytubeBot.prototype.listBlockedUsers = () => {
  var bot = this;
...
// if they don't exist
CytubeBot.prototype.readPersistentSettings = callback => {
  var bot = this;
...
// callback - The callback function
CytubeBot.prototype.readTimes = callback => {
...
CytubeBot.prototype.sendChatMsg = (message, override) => {
...
CytubeBot.prototype.sendHybridModPermissions = name => {
  if (name) {
...
CytubeBot.prototype.sendMoveMedia = from => {
...
// msg - The message
CytubeBot.prototype.sendPM = (to, msg) => {
  if (!to) {
    return;
  }
...
CytubeBot.prototype.sendStatus = () => {
...
CytubeBot.prototype.sendUnban = json => {
...
CytubeBot.prototype.shufflePlaylist = () => {
...
CytubeBot.prototype.storeUsercount = count => {
...
CytubeBot.prototype.talk = (message, callback) => {
  var self = this;
...
CytubeBot.prototype.turnOffLogging = () => {
...
CytubeBot.prototype.validateVideo = (video, callback) => {
  var bot = this;
...
CytubeBot.prototype.updatePersistentSettings = () => {
  var changed = false
...
// Used by various methods
CytubeBot.prototype.writePersistentSettings = () => {
  var bot = this;
